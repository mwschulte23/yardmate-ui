<template>
    <v-card flat class="bg-white text-dark rounded-lg h-100" max-height="500">
            ...
            <div v-if="this.$store.state.locationIds.length > 0">
                <v-card-text>
            ...
            <div v-else class="d-flex justify-center align-center h-50">
                <p class="text-h5 text-grey-darken-1 font-weight-light">Please select locations from table</p>
            </div>
    </v-card>
</template>
